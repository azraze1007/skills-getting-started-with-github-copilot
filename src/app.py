...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, learn stroke techniques, and prepare for swim meets",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "maria@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and mixed media art projects",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["lily@mergington.edu", "cameron@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, improvise, and stage dramatic performances",
